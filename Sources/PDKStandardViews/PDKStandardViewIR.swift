...
public struct PDKStandardViewIR: Sendable, Hashable, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            layerNames: try container.decode([String].self, forKey: .layerNames),
            physicalLayerNumbers: try container.decode([Int].self, forKey: .physicalLayerNumbers),
            cellNames: try container.decode([String].self, forKey: .cellNames),
            viaNames: try container.decode([String].self, forKey: .viaNames),
            modelNames: try container.decode([String].self, forKey: .modelNames),
            modelTypes: try container.decode([String].self, forKey: .modelTypes),
            modelParameterNames: try container.decode([String].self, forKey: .modelParameterNames),
            spiceModels: try container.decode([PDKSpiceModel].self, forKey: .spiceModels),
            spiceSubcircuits: try container.decode([PDKSpiceSubcircuit].self, forKey: .spiceSubcircuits),
            pinNames: try container.decode([String].self, forKey: .pinNames),
            cornerNames: try container.decode([String].self, forKey: .cornerNames),
            timingArcCount: try container.decode(Int.self, forKey: .timingArcCount),
            timingRelatedPinNames: try container.decode([String].self, forKey: .timingRelatedPinNames),
            timingTableValueCount: try container.decode(Int.self, forKey: .timingTableValueCount),
            libertyCells: try container.decode([PDKLibertyCell].self, forKey: .libertyCells),
            libertyTimingArcs: try container.decode([PDKLibertyTimingArc].self, forKey: .libertyTimingArcs),
            libertyTimingTables: try container.decode([PDKLibertyTimingTable].self, forKey: .libertyTimingTables),
            unitDeclarations: try container.decode([String: String].self, forKey: .unitDeclarations),
